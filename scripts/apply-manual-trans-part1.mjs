...
const translations = {
  ...
  "terms_intro_body1": {"de": "Diese Nutzungs- und Verkaufsbedingungen (\\\"Bedingungen\\\") regeln Ihren Zugang zu auroraforecast.uk und allen Premium-Aurora-Vorhersageprodukten (\\\"Premium-Zugang\\\"). Durch den Besuch der Website oder den Kauf von Premium-Zugang stimmen Sie diesen Bedingungen zu.", "es": "Estos Términos de Uso y Venta (\\\"Términos\\\") rigen su acceso a auroraforecast.uk y cualquier producto de pronóstico aurora premium (\\\"Acceso Premium\\\"). Al visitar el sitio o comprar Acceso Premium, usted acepta estos Términos.", "fr": "Ces Conditions d'Utilisation et de Vente (« Conditions ») régissent votre accès à auroraforecast.uk et à tous les produits de prévision d'aurores premium (« Accès Premium »). En visitant le site ou en achetant un Accès Premium, vous acceptez ces Conditions.", "no": "Disse bruksvilkårene og salgsvilkårene (\\\"Vilkår\\\") regulerer din tilgang til auroraforecast.uk og alle premium nordlys-varslingsprodukter (\\\"Premium-tilgang\\\"). Ved å besøke nettstedet eller kjøpe Premium-tilgang godtar du disse Vilkårene."},
